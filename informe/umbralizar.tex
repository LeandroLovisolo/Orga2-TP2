...
\begin{center}
  \begin{tikzpicture}[scale=0.75]
    \registroDieciseis{\xmm{1}}{0}{4}
                      {A15}{A14}{A13}{A12}{A11}{A10}{A9}{A8}{A7}
                      {A6}{A5}{A4}{A3}{A2}{A1}{A0}

    \draw [->, thick] (15.5, 4) -- (15.5, 3); % A0
    \draw [->, thick] (14.5, 4) -- (13.5, 3); % A1
    \draw [->, thick] (13.5, 4) -- (11.5, 3); % A2
    \draw [->, thick] (12.5, 4) -- ( 9.5, 3); % A3
    \draw [->, thick] (11.5, 4) -- ( 7.5, 3); % A4
    \draw [->, thick] (10.5, 4) -- ( 5.5, 3); % A5
    \draw [->, thick] ( 9.5, 4) -- ( 3.5, 3); % A6
    \draw [->, thick] ( 8.5, 4) -- ( 1.5, 3); % A7
    \draw [->, thick] ( 7.5, 4) -- (15.5, 1); % A8
    \draw [->, thick] ( 6.5, 4) -- (13.5, 1); % A9
    \draw [->, thick] ( 5.5, 4) -- (11.5, 1); % A10
    \draw [->, thick] ( 4.5, 4) -- ( 9.5, 1); % A11
    \draw [->, thick] ( 3.5, 4) -- ( 7.5, 1); % A12
    \draw [->, thick] ( 2.5, 4) -- ( 5.5, 1); % A13
    \draw [->, thick] ( 1.5, 4) -- ( 3.5, 1); % A14
    \draw [->, thick] ( 0.5, 4) -- ( 1.5, 1); % A15   

    \registroDieciseis{\xmm{1}}{0}{2}
