...
\begin{itemize}
	...
	\begin{figure}[H]
		...
		\begin{tikzpicture}[scale=0.75]
			...
			\draw (0,  1) node[anchor=north west]{\scriptsize{X16+Y16+}}
			     +(0, -1) node[anchor=south west]{\scriptsize{X15+Y15}}
                ++(2,  0) node[anchor=north west]{\scriptsize{X14+Y14+}}
                 +(0, -1) node[anchor=south west]{\scriptsize{X13+Y13}}
                ++(2,  0) node[anchor=north west]{\scriptsize{X12+Y12+}}
                 +(0, -1) node[anchor=south west]{\scriptsize{X11+Y11}}
                ++(2,  0) node[anchor=north west]{\scriptsize{X10+Y10+}}
                 +(0, -1) node[anchor=south west]{\scriptsize{X9+Y9}}
                ++(2,  0) node[anchor=north west]{\scriptsize{X8+Y8+}}
                 +(0, -1) node[anchor=south west]{\scriptsize{X7+Y7}}
                ++(2,  0) node[anchor=north west]{\scriptsize{X6+Y6+}}
                 +(0, -1) node[anchor=south west]{\scriptsize{X5+Y5}}
                ++(2,  0) node[anchor=north west]{\scriptsize{X4+Y4+}}
                 +(0, -1) node[anchor=south west]{\scriptsize{X3+Y3}}
                ++(2,  0) node[anchor=north west]{\scriptsize{X2+Y2+}}
                 +(0, -1) node[anchor=south west]{\scriptsize{X1+Y1}};
