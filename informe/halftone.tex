...
\begin{pseudocodigo}
  ...
  \ENDIF
  \IF{la altura la imagen es impar}
...
\begin{itemize}
  ...
  Para esto utilizamos los registros \xmm{12} al \xmm{15}, en los cuales están guardados en packed word los valores $205$, $410$, $615$ y $820$.
