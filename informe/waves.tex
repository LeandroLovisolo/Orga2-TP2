...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item En un registro XMM se le pone en todos sus doublewords el valor de $j$ utilizando la instrucciones \asm{MOVQ} que mueve un doubleword en la parte baja del registro XMM y extiende el resto del registro con $0$ y SHUFPS que lo expande en las demás doublewords del registro. 
